...
LoadParameters<-function()
{
  ...
  parameters$percGroup=.2     # Percentage of Biased Group
  ...
  parameters$daylength=100     # Length of Day
  parameters$traveltime=1     # Travel Time
  parameters$detaintime=5      # Detain Time
...
View(RLsolutionSusp)
View(RLsolutionDirect)
View(RLsolutionIndirect)
