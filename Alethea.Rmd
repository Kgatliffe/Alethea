...
save(testCrim, file = paste0("testCrim.daylength.",parameters$daylength,".numtrain.",parameters$numtrain,".numtest.",parameters$numtest,".itertrain.",parameters$itertrain,".rda"))
testRandom<-statediagramfunction(RLtestsampleRandom, parameters)
testmodelRandom<-runRLinit(testRandom,parameters)
save(testRandom, file = paste0("testRandom.daylength.",parameters$daylength,".numtrain.",parameters$numtrain,".numtest.",parameters$numtest,".itertrain.",parameters$itertrain,".rda"))
