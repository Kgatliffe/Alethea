...
setwd("~/Alethea")
simpledat <- read.csv("~/Alethea/statemap.csv")
# Load dataset
...
model1 <- ReinforcementLearning(simpledat, s = "State", a = "Action", r = 
                                 "Reward", 
                               s_new = "NextState", iter = 1, control = control)
model2 <- ReinforcementLearning(simpledat, s = "State", a = "Action", r = 
                                 "Reward", 
                               s_new = "NextState", iter = 1000, control = control)
model3 <- ReinforcementLearning(simpledat, s = "State", a = "Action", r = 
                                 "Reward", 
                               s_new = "NextState", iter = 1, control = control, model=model2)
# Print optimal policy
policy1<-computePolicy(model1)
View(policy1)
policy2<-computePolicy(model2)
View(policy2)
policy3<-computePolicy(model3)
View(policy3)
write.csv(policy1, file = "policy1.2.csv",row.names=TRUE)
write.csv(policy2, file = "policy2.2.csv",row.names=TRUE)
write.csv(policy3, file = "policy3.2.csv",row.names=TRUE)
print.rl(model3)
```
